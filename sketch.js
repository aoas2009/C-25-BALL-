...
function setup() {
	...
	bottomSide = new Ground(1185,657,150,20);
...
function draw() {
	...
	fill("black");
	textSize(21);
	text("Aperte SETA PARA CIMA para mover a bola de papel", 50, 100);
	pop();
	...
	image(paperImg, ball.position.x, ball.position.y, 120,120)
